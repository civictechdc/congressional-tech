...
function DashboardContent(param) {
    let {} = param;
    _s();
    const { data, error, isError, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$youtube$2d$event$2d$id$2d$report$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
...
_s(DashboardContent, "g52tkK1ETYRCGCahrzn4rDXg/zU=", false, function() {
    return [
...
//# sourceMappingURL=_ade65323._.js.map